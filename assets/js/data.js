const data = {
  skills: {
    knownKnown: [
      ...
      },
      {
        ...
        src: "assets/images/Object Oriented Programming.jpg",
        alt: "OOPs",
      },
      {
      ...
      {
        title: "HTML - Markup Language for the Web",
        src: "https://raw.githubusercontent.com/devicons/devicon/master/icons/html5/html5-original.svg",
        alt: "HTML",
      },
      {
        title: "CSS - Style the Web",
        src: "https://raw.githubusercontent.com/devicons/devicon/master/icons/css3/css3-original.svg",
        alt: "CSS",
      },
      {
        title: "JavaScript - Programming Language of the Web",
        src: "https://raw.githubusercontent.com/devicons/devicon/master/icons/javascript/javascript-original.svg",
        alt: "JavaScript",
      },
      {
        title: "React - Frontend JavaScript Library",
    ...
    knownUnknown: [
      ...
      {
        title: "Flask - Python micro web framework",
      ...
      {
        title: "Scikit-learn - ML Library in Python",
      ...
      {
        title: "Electron JS - Desktop App Framework",
    ...
    unknownKnown: [
      ...
      {
        title: "GitHub - Collaborative Coding",
      ...
      {
        title: "IntelliJ IDEA - Java IDE",
        src: "https://resources.jetbrains.com/storage/products/company/brand/logos/IntelliJ_IDEA_icon.png",
        alt: "IntelliJ IDEA",
      },
      {
      ...
      {
        title: "Android Studio - IDE for Android Development",
        src: "assets/images/Android Studiop.webp",
        alt: "Android Studio",
      },
      {
  ...
  certificates: [
    ...
    },
    {
      ...
      icons: [
        ...
        {
          title: "Cloud Services - AWS Basics",
  ...
  socials: [
    ...
    {
      name: "Codolio",
      url: "https://codolio.com/profile/manoj_0207",
      imgSrc: "assets/images/Codolio.png",
      tooltip: "Codolio",
    },
    {
      name: "Kaggle",
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  navLinks.forEach((link) => {
    link.addEventListener("click", (e) => {
      ...
      if (target) {
        window.scrollTo({
          top:
            target.offsetTop - document.getElementById("navbar").offsetHeight,
          behavior: "smooth",
        });
        clearActiveClasses();
  ...
  document.querySelectorAll(".quadrant").forEach((cell) => {
    cell.addEventListener("mouseenter", () => {
      ...
      const columnHeader =
        table.querySelector(`tr:first-child`).children[colIndex];
  ...
  const techLinksKU = document.querySelectorAll(
    "#knownUnknown .tech-icons div"
  );
  const techLinksUK = document.querySelectorAll(
    "#unknownKnown .tech-icons div"
  );
